    ...
    <body>
        ...
        <form  action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']) ?>" method="POST">
            ...
            <fieldset>
                ...
                $sql1 = "select * from delivery where status = 'pending' and dman = '".$userid."'";
		        $res1 = $conn->query($sql1);

		        if($res1->num_rows > 0) {
			        while($row = $res1->fetch_assoc()) {
				        echo "id: " . $row['orderid']."=> Person Name: " .$row['pname']."=> Order title: " .$row['otitle']."=> Quantity: " .$row['quantity']."=> Phone no: " .$row['phnno'];
				        echo "<br>";
			        }
		        }
                ?>                
